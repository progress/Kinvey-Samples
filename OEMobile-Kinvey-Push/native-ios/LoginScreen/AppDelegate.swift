...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        Kinvey.sharedClient.initialize(appKey: "kinveyAppKey", appSecret: "kinveyAppSecret") { user, error in
            if let _ = user {
...
//        return SDKApplicationDelegate.shared.application(application, didFinishLaunchingWithOptions: launchOptions)
    ...
    func application(_ application: UIApplication, didReceiveRemoteNotification userInfo: [AnyHashable : Any]) {
        ...
        let alert = UIAlertController(title: "Notification", message: notification["alert"].stringValue, preferredStyle: UIAlertControllerStyle.alert)
        alert.addAction(UIAlertAction(title: "Done", style: UIAlertActionStyle.default, handler: {(_ action: UIAlertAction) -> Void in
            // continue your work
